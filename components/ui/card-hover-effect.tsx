...
export const HoverEffect = ({
  ...
  return (
    ...
    >
      {items.map((item, idx) => (
        // to make the card clickable into a link, simply change the div into a Link and uncomment the href
        <div
          // href={item?.link}
          key={item?.link}
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-orange-200/90   hover:cursor-pointer relative z-20 ",
        className
      )}
    >
...
export const CardTitle = ({
  ...
  return (
    <h4 className={cn("text-stone-900 font-bold text-xl", className)}>
      {children}
    </h4>
  );
};
